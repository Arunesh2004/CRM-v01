...
import { updateCustomerAction } from '@/modules/crm/actions/customer.actions';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-0 animate-in fade-in duration-200">
          ...
          >
            ...
            <div className="px-6 py-5 border-b border-white/[.06] flex items-center justify-between" style={{ background: 'rgba(13,19,38,.6)' }}>
              <div>
                <h2 className="text-xl font-display font-bold text-white tracking-tight">Edit Customer</h2>
                <p className="text-sm text-[#8891B0] mt-1">Update enterprise account details.</p>
              </div>
              <button 
                onClick={() => setIsOpen(false)}
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              ...
              <div>
                ...
                >
                  <option value="ACTIVE" className="bg-[#0D1326]">Active</option>
                  <option value="INACTIVE" className="bg-[#0D1326]">Inactive</option>
