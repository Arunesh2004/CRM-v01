      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="space-y-3 text-sm">
             <div><span className="font-medium text-gray-600">Company Name:</span> Acme Corporation</div>
             <div><span className="font-medium text-gray-600">Tenant ID:</span> tenant_123456789</div>
