  ...
  return (
    <div className="space-y-6 h-full flex flex-col animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-primary">Leads Pipeline</h1>
          <p className="text-sm text-muted-foreground mt-1">Track and convert incoming regional prospects.</p>
        </div>
